                ...
                <div class="floatd">
                    ...
                    <div>
                        <ul>
                            ...
                            <li><a href="{{ route('category','beverages') }}">Beverages</a></li>
                            <li><a href="{{ route('category','condiments-spices') }}">Condiments & Spices</a></li>
                            <li><a href="{{ route('category','dairy') }}">Dairy</a></li>
                            <li><a href="{{ route('category','frozen') }}">Frozen</a></li>
                            <li><a href="{{ route('category','fruits') }}">Fruits</a></li>
                            <li><a href="{{ route('category','gourmet') }}">Gourmet</a></li>
                            <li><a href="{{ route('category','grains-beans-cereals') }}">Grain, Beans & Cereals</a></li>
                            <li><a href="{{ route('category','oils-vinegars') }}">Oils & Vinegars</a></li>
                        </ul>
                    </div>
                    <div>
                        <ul>
                            <li><a href="{{ route('category','olives-capers') }}">Olives & Capers</a></li>
                            <li><a href="{{ route('category','seafood') }}">Seafood</a></li>
                            <li><a href="{{ route('category','seasonal') }}">Seasonal</a></li>
                            <li><a href="{{ route('category','vegetables') }}">Vegetables</a></li>
                            <li>&nbsp;</li>
