        ...
        <div>
            ...
            <ul class="lines">
                ...
                @if($product->nutrition_facts <> '')
                    <a href="uploads/products/nf/{{ $product->nutrition_facts }}" target="_blank">NUTRITION FACTS</a>
                @else
                    <span>NUTRITION FACTS</span>
                @endif
                </li><li>
                @if($product->spec_sheets <> '')
                    <a href="uploads/products/ss/{{ $product->spec_sheets }}" target="_blank">SPEC SHEET</a>
                @else
